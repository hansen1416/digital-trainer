...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ReportComponent")));
bytes32 constant ReportComponentTableId = _tableId;

library ReportComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "name";
    return ("ReportComponent", _fieldNames);
  }
  ...
  /** Get name */
  function get() internal view returns (string memory name) {
  ...
  function get(IStore _store) internal view returns (string memory name) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  /** Set name */
  function set(string memory name) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function set(IStore _store, string memory name) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
